    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            >
                ...
                <div class="navbar-nav-right d-flex align-items-center w-px" id="navbar-collapse">
                    <!-- Search -->
                    ...
                    <div class="card-body">
                       <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group input-group-merge">
                                <span class="input-group-text" id="icon-description">
                                    <i class="bx bxs-pen"></i>
                                </span>
                                <textarea class="form-control p-1" id="course-desc" placeholder="Enter course description here..." aria-describedby="icon-description"></textarea>
                            </div>
                        </div>

                        <div>
                            <label for="course-privacy" class="form-label" >Privacy: </label>
                            <select id="course-privacy" name="privacy" class="form-select w-25">
                                <option value="1">public</option>
                                <option value="2">private</option>
                                <option value="3">request-only</option>
                            </select>
                        </div>
                    </div>
